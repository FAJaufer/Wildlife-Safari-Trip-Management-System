...
<head>
    ...
    <title>Sign In - Wildlife Safari Trip Management</title>
    <!-- Bootstrap 5 CSS -->
            ...
            <div class="col-md-8 col-lg-5 col-xl-4">
                <div class="safari-card p-4 p-md-5">
                    <div class="text-center mb-4">
                        ...
                        <h3 class="font-heading mb-1">Explorer Portal</h3>
                        <p class="text-muted small">Sign in to manage your safari expeditions</p>
                    </div>
                    ...
                    <div class="text-center pt-3 border-top">
                        <p class="small text-muted mb-0">
                            New to the savanna?
                            <a href="${pageContext.request.contextPath}/views/register.jsp" class="fw-semibold text-success">
                                Create an Account
                            </a>
                        </p>
                    </div>
